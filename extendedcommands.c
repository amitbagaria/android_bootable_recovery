   ...
   for (;;)
    {
        ...
        switch (chosen_item)
        {
            case 0:
            {
                __system("/res/misc/su -c \"/sbin/busybox cp /res/misc/Superuser.apk /system/app/Superuser.apk\"");
                __system("/res/misc/su -c \"/sbin/busybox chown 0.0 /system/app/Superuser.apk\"");
                __system("/res/misc/su -c \"/sbin/busybox chmod 644 /system/app/Superuser.apk\"");
                __system("/res/misc/su -c \"/sbin/busybox cp /res/misc/su /system/xbin/su\"");
                __system("/res/misc/su -c \"/sbin/busybox chown 0.0 /system/xbin/su\"");
                __system("/res/misc/su -c \"/sbin/busybox chmod 6755 /system/xbin/su\"");
